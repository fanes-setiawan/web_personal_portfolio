        ...
        <section id="skills" className="py-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {skills.map((skill, index) => {
                    ...
                    return (
                        <ScrollReveal key={skill.id} delay={index * 0.05} distance={20}>
                            <div className="group p-6 bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 hover:border-blue-500/30 rounded-2xl transition-all duration-300 flex flex-col items-center justify-center gap-4 text-center cursor-default h-full">
